...
if __name__ == '__main__':
    ...
    parser.add_argument("--methods", action="store", type=str, required=False, default="",
                        help="what data should be part of the test data, available are human, gpt2, gpt3, gpt4, grover")
    ...
    elif not ("human" in methods or "gpt4" in methods or "gpt3" in methods or "gpt2" in methods or "grover" in methods):
    ...
    for query in args.queries.split(","):
        ...
        for url in urls:
            ...
            gpt4, gpt3, gpt2, grover, human = None, None, None, None
            if "gpt2" in methods:
                try:
