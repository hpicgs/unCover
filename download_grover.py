# This is just for downloading the grover generator. Original Code taken from https://github.com/rowanz/grover
...
model_dir = os.path.join(MODELS_DIR, "grover-" + model_type)
