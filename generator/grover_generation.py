...
from generator.grover.modeling import GroverConfig, sample
from generator.grover.encoder import get_encoder, _tokenize_article_pieces, extract_generated_target
from definitions import MODELS_DIR
from tqdm import tqdm


def generate_grover_news_from_original(doc, model):
    encoder = get_encoder()
    grover_path = os.path.join(MODELS_DIR, "grover-" + model)
